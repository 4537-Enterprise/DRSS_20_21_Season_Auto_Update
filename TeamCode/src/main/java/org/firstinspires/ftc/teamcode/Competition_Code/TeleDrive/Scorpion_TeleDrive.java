...
@TeleOp(name = "Scorpion_TeleDrive", group = "TeleDrive_TeleOp")
public class Scorpion_TeleDrive extends LinearOpMode {

    private final InitHardware_TeleDrive robot = new InitHardware_TeleDrive();  //Load hardware from hardware map
